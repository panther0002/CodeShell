...
const CourseCard = ({cardData,currentCard,setCurrentCard}) => {
  return (
    <div className={` ${ cardData.heading ===currentCard 
        ...
        <div className='flex flex-col mt-2 mb-20 px-6 py-6'>
            <p className='text-xl mb-1 font-semibold'>{cardData.heading}</p>
        ...
        <div className={`flex flex-row justify-between px-6 py-3 text-blue-300
           `}
            >
            ...
            <div className='flex flex-row gap-2  '>
                <svg xmlns="http://www.w3.org/2000/svg" width="19" height="18" viewBox="0 0 19 18" fill="none">
                    <g clipPath="url(#clip0_11167_18357)">
